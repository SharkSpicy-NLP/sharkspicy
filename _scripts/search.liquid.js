...
ninja.data = [
  ...
  {%- for p in sorted_pages -%}
    {%- if p.nav and p.autogen == null and p.permalink != '/cv/' and p.title != 'CV' -%}
      {%- if p.dropdown -%}
  ...
  {%- for collection in site.collections -%}
    {%- if collection.label != 'posts' and collection.label != 'projects' and collection.label != 'teachings' and collection.label != 'books' -%}
